...
WITH
    ...
    CROSS JOIN Subjects AS sub
        -- * includes all possible combinations of student id and subject name
    )

SELECT CTE.student_id, CTE.student_name, CTE.subject_name, COUNT(e.subject_name) AS attended_exams
FROM CTE
    LEFT JOIN Examinations AS e ON CTE.student_id = e.student_id AND CTE.subject_name = e.subject_name
